	...
	<table style="width: 100%; text-align: center; border: 1px solid #CCC; font-size: 9pt;">
		<tr>
			<td colspan = "3" style="background-color: #CCC; color: #000;">
				<b>{l s=' DETALLES DE ENVIO #' pdf='true'}{$smarty.foreach.shippingsLoop.iteration}</b>
			</td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td style="width: 33%; background-color: #8B0000; color: #FFF;">
				<b>{$shipping.state_name}</b>
			</td>
			<td style="width: 34%;">

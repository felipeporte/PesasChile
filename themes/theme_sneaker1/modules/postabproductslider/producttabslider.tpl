...
<div class="product-tabs-container-slider product_block_container">
	<div class="tabs_slider"> 
		...
		<p class="desc-title">{l s='Our store is more than just another average online retailer. We sell not only top quality products, but give our customers a positive online shopping experience.'  d='Shop.Theme.Global'}</p>
	</div>

...
class PosListCateProduct extends Module implements WidgetInterface
{
	...
	public function install()
	{
		...
		foreach ($shops as $shop_id)
		{
			...
			$res &= Configuration::updateValue($this->name.'_per_lg', $this->default_per_md, false, $shop_group_id, $shop_id);
		...
		$res &= Configuration::updateValue($this->name.'_per_lg', $this->default_per_md);
	...
	protected function installDemoData()
	{
		...
		for ($i = 1; $i <= 2; ++$i)
		{
			...
			$item->list_subcategories= '8,9,10,11';
	...
	public function getConfigFieldsValues()
	{
		...
		return array(
			...
			$this->name.'_per_lg' => Tools::getValue($this->name.'_per_md', Configuration::get($this->name.'_per_lg', null, $id_shop_group, $id_shop)),
